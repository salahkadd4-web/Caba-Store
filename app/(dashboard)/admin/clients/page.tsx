...
import {
  card, cardSm, heading, inputCls, btnPrimaryPurple, btnSecondary, btnDanger, btnDangerSolid,
  tableWrapper, tableHead, tableTh, tableTd, tableRow,
  modalOverlay, modalBox, loadingPage, toastCls,
...
export default function AdminClientsPage() {
  ...
  if (loading && !searching) {
    return <div className={loadingPage}><Spinner cls="w-5 h-5 text-orange-500" /><span className="ml-2">Chargement…</span></div>
  }
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="bg-orange-50 dark:bg-orange-950 rounded-xl p-4 flex items-center gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-orange-500 dark:text-orange-400">Gérés via Flowmerce.</p>
                    </div>
                    <a href={process.env.NEXT_PUBLIC_FLOWMERCE_DASHBOARD_URL ?? "https://flowmerce.com"} target="_blank" rel="noopener noreferrer"
